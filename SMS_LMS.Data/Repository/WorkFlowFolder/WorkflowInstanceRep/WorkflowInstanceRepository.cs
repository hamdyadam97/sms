...
namespace SMS_LMS.Data.Repository.WorkFlowFolder.WorkflowInstanceRep
{
    public class WorkflowInstanceRepository : Repository<WorkflowInstance>, IWorkflowInstanceRepository
    {
        ...
        public WorkflowInstanceRepository(SMS_LMS_DBContext db, IMapper mapper) : base(db, mapper)
        {
            _mapper = mapper;
            _db = db;
        }
